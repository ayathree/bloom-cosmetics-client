        ...
        <div className="mt-20">
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:grid-rows-2 md:grid-rows-3 grid-rows-6 justify-center items-center gap-4">
                <div className="overflow-hidden group relative">
                    ...
                    <button className="text-black bg-white px-6 py-2  border-black border-2 bottom-12 left-24 right-24 absolute  lg:font-bold hover:bg-black hover:text-white uppercase">Lipsticks</button>
                </div>
                <div className="overflow-hidden group relative">
                    ...
                    <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-white/30 to-transparent opacity-0 group-hover:opacity-100 group-hover:translate-x-0 translate-x-full transition-all duration-500"></div>
                    <button className="text-black bg-white px-6 py-2  border-black border-2 bottom-12 left-24 right-24 absolute  lg:font-bold hover:bg-black hover:text-white uppercase">Eye shadows</button>
                </div>
                <div className="overflow-hidden group relative">
                    ...
                    <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-white/30 to-transparent opacity-0 group-hover:opacity-100 group-hover:translate-x-0 translate-x-full transition-all duration-500"></div>
                    <button className="text-black bg-white px-6 py-2  border-black border-2 bottom-12 lg:left-24 lg:right-24 left-16 right-16  absolute  lg:font-bold hover:bg-black hover:text-white uppercase">foundations</button>
                </div>
                <div className="overflow-hidden group relative">
                    ...
                    <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-white/30 to-transparent opacity-0 group-hover:opacity-100 group-hover:translate-x-0 translate-x-full transition-all duration-500"></div>
                    <button className="text-black bg-white px-6 py-2  border-black border-2 bottom-12 lg:left-24 lg:right-24 left-16 right-16 absolute  lg:font-bold hover:bg-black hover:text-white uppercase">Mascaras</button>
                </div>
                <div className="overflow-hidden group relative">
                    ...
                    <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-white/30 to-transparent opacity-0 group-hover:opacity-100 group-hover:translate-x-0 translate-x-full transition-all duration-500"></div>
                    <button className="text-black bg-white px-6 py-2  border-black border-2 bottom-12 left-24 right-24 absolute lg:font-bold hover:bg-black hover:text-white uppercase">body mists</button>
                </div>
                <div className="overflow-hidden group relative">
                    ...
                    <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-white/30 to-transparent opacity-0 group-hover:opacity-100 group-hover:translate-x-0 translate-x-full transition-all duration-500"></div>
                    <button className="text-black bg-white px-6 py-2  border-black border-2 bottom-12 left-24 right-24 absolute lg:font-bold hover:bg-black hover:text-white uppercase">MakeUp Kits</button>
                </div>
            </div>
